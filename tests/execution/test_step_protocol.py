...
class StepProtocolTest(unittest.TestCase):
    ...
    def test_worker_advertises_supported_step_capabilities(self):
        ...
        self.assertIn("dataset.extract-row-map", executions.CAPABILITIES)
        self.assertIn("dataset.extract-row-reduce", executions.CAPABILITIES)
        ...
        self.assertIn("date-extraction-map", executions.CAPABILITIES)
        self.assertIn("date-extraction-reduce", executions.CAPABILITIES)
        self.assertNotIn("date-extraction", executions.CAPABILITIES)
        ...
        self.assertIn("key-point-map", executions.CAPABILITIES)
        self.assertIn("key-point-reduce", executions.CAPABILITIES)
        self.assertNotIn("key-point", executions.CAPABILITIES)
