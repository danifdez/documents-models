...
from common.dataset import load_dataset, safe_float, dataset_labels
import pandas as pd
...
def pivot_table(payload) -> dict:
    ...
    try:
        ...
        rows = dataset_labels(schema, row_field, raw_rows)
        cols = dataset_labels(schema, col_field, raw_cols)
